...
#define DISCOUNT 5.00          //Процент скидки за заказ на сумму > 100$
...
#define DELIV 6.50             //Стоимость доставки весом < или == 5 фунтам
#define DELIV_UP 14.00         //Стоимость доставки весом > 5 < 20 фунтов
#define DELIV_UN_BOR 0.50      //Стоимость доставки каждого фунта > 20 уже имеющихся
